...
public class Blacklist extends ListActivity {
	...
	protected Dialog onCreateDialog(int id) {
						...
						public void onClick(DialogInterface dialog, int whichButton) {
							if (input.getText().toString() != null) {
								try {
									...
									Toast
											.makeText(Blacklist.this, "Phone number already exists in either whitelist or blacklist.",
		...
		case 1:
			...
			final AlertDialog dialog2 = new AlertDialog.Builder(Blacklist.this).setTitle(R.string.update_entry).setView(input2).setPositiveButton(
					R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
							if (input2.getText().toString() != null) {	//BURDA TEXTINI CEKIP SETLEMEK LAZIM
								...
								Toast
								.makeText(Blacklist.this, "Entry cannot be empty.",
										Toast.LENGTH_LONG).show();
							}
						}
					}).setNegativeButton(R.string.alert_dialog_cancel, new DialogInterface.OnClickListener() {
